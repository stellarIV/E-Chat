...
const Body = (props: Props) => {
  ...
  return (
    <div className='flex-1 w-full flex overflow-y-scroll flex-col-reverse gap-3 p-3 no-scrollbar'>{messages?.map(({message, senderImage, senderName, isCurrentUser}, index)=>{
